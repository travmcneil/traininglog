        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DistanceMiles = table.Column<decimal>(type: "decimal(6,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Races_TrainingPlans_TrainingPlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlannedDistanceMiles = table.Column<decimal>(type: "decimal(6,2)", nullable: true),
                    ActualDistanceMiles = table.Column<decimal>(type: "decimal(6,2)", nullable: true),
                    PlannedPace = table.Column<TimeSpan>(type: "time", nullable: true),
                    ActualPace = table.Column<TimeSpan>(type: "time", nullable: true),
